...
export default function ShowtimesTable({ showtimes, onEdit, onDelete, onClearAll}) {
  return (
          ...
          <tbody>
            ...
            {showtimes.map((s, i) => (
              <tr key={i} className="text-center">
                <td className="p-2 border">{s.movieId}</td>
                <td className="p-2 border">{s.locationId}</td>
